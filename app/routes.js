module.exports = function (app, passport) {
	...
	// KALE FINDER SECTION ====================
	// ====================================
	// app.get('/kalefinder', isLoggedIn, function (req, res) {
	// 	res.render('kalefinder.html', {
	// 		user : req.user // get the user out of session and pass to template
	// 	});
	// });
	app.get('/kalefinder', function (req, res) {
		res.render('kalefinder.ejs'); // load index.ejs file
	})

	// GOINSTANT SECTION ====================
	// ====================================
	app.get('/goinstant', function (req, res) {
		res.render('goinstant.ejs');
	});
	...
	// DROPNET SECTION ====================
	// ====================================
	app.get('/dropnet', isLoggedIn, function (req, res) {
		res.render('dropnet.ejs', {
			user : req.user // get the user out of session and pass to template
		});
	});
	...
	// DROPNET SECTION ====================
	// ====================================
	app.get('/droptest', isLoggedIn, function (req, res) {
		res.render('droptest.ejs', {
			user : req.user // get the user out of session and pass to template
		});
	});
